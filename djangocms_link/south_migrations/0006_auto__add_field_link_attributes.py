...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.attributes'
        db.add_column(u'djangocms_link_link', 'attributes',
                      self.gf('djangocms_attributes_field.fields.AttributesField')(default={}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.attributes'
        db.delete_column(u'djangocms_link_link', 'attributes')
    ...
    models = {
        ...
        u'djangocms_link.link': {
            ...
            'attributes': ('djangocms_attributes_field.fields.AttributesField', [], {'default': '{}', 'blank': 'True'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'djangocms_link_link'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['cms.CMSPlugin']"}),
            'mailto': ('django.db.models.fields.EmailField', [], {'max_length': '254', 'null': 'True', 'blank': 'True'}),
